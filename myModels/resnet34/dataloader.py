...
from utils.img_aug_utils import random_scale, random_mirror, normalize, \
    generate_random_crop_pos, random_crop_pad_to_shape

# binary filter for image with threshold:
# image will be convert to black and white
...
# train_dataset + train_dataset_no_crop
