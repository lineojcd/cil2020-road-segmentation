...
#function only for saving checkpoint
    def save_checkpoint(self, path):
        ...
        state_dict['myModels'] = new_state_dict
...
#Function for saving current training myModels parameters and create symbolic link under current folder
...
#Funtion for continuing training is interrupted        
    ...
    def restore_checkpoint(self):
        ...
        self.state.model = load_model(self.state.model, tmp['myModels'],
                                      True)
